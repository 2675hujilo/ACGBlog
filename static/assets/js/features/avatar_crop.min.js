...
var bgImg = document.getElementById('avatar-crop-bg');
var cropImg = document.getElementById('avatar-crop-img');
var zoom = document.getElementById('avatar-crop-zoom');
var fitBtns = document.querySelectorAll('.avatar-fit-btn');
...
var contain = Math.min(V / state.naturalW, V / state.naturalH);
...
if (!state.ready || !fileInput.files[0]) return;
e.preventDefault();
var V = viewport.clientWidth || 240;
